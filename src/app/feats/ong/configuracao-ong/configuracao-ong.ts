...
@Component({
  selector: 'app-configuracao-ong', imports: [OngShell],
  templateUrl: './configuracao-ong.html', styleUrls: ['../shared/ong-pages.css', '../shared/ong-widgets.css', '../shared/ong-responsive.css', './configuracao-ong.css'],
...
export class ConfiguracaoOng {
  ...
  constructor() {
    afterNextRender(() => {
      const cleanup = initializeOngPage(this.host.nativeElement, 'configuracoes', {
