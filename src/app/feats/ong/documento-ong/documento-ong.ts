...
@Component({
  selector: 'app-documento-ong', imports: [OngShell],
  templateUrl: './documento-ong.html', styleUrls: ['../shared/ong-pages.css', '../shared/ong-widgets.css', '../shared/ong-responsive.css', './documento-ong.css'],
...
export class DocumentoOng {
  ...
  constructor() {
    afterNextRender(() => {
      const cleanup = initializeOngPage(this.host.nativeElement, 'documentos', {
