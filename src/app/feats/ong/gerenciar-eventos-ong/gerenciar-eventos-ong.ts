...
@Component({
  selector: 'app-gerenciar-eventos-ong', imports: [OngShell],
  templateUrl: './gerenciar-eventos-ong.html', styleUrls: ['../shared/ong-pages.css', '../shared/ong-widgets.css', '../shared/ong-responsive.css', './gerenciar-eventos-ong.css'],
...
export class GerenciarEventosOng {
  ...
  constructor() {
    afterNextRender(() => {
      const cleanup = initializeOngPage(this.host.nativeElement, 'eventos', {
