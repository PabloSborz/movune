...
@Component({
  selector: 'app-gerenciar-vaga-ong', imports: [OngShell],
  templateUrl: './gerenciar-vaga-ong.html', styleUrls: ['../shared/ong-pages.css', '../shared/ong-widgets.css', '../shared/ong-responsive.css', './gerenciar-vaga-ong.css'],
...
export class GerenciarVagaOng {
  ...
  constructor() {
    afterNextRender(() => {
      const cleanup = initializeOngPage(this.host.nativeElement, 'vagas', {
