...
@Component({
  selector: 'app-gerenciar-voluntario-ong', imports: [OngShell],
  templateUrl: './gerenciar-voluntario-ong.html', styleUrls: ['../shared/ong-pages.css', '../shared/ong-widgets.css', '../shared/ong-responsive.css', './gerenciar-voluntario-ong.css'],
...
export class GerenciarVoluntarioOng {
  ...
  constructor() {
    afterNextRender(() => {
      const cleanup = initializeOngPage(this.host.nativeElement, 'voluntarios', {
