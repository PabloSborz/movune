...
export const initialRows: Partial<Record<PageKind, Row[]>> = {
  vagas: [
...
export const columns: Partial<Record<PageKind, [string, string][]>> = {
  vagas: [
    ['name', 'Vaga'],
    ['mode', 'Modalidade'],
    ['count', 'Inscritos'],
...
export function documentStatus(date: string, now = new Date()): string {
  if (!date) return 'Válido';
